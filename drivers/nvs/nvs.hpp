/* 
 * This file is originally from the https://github.com/howroyd/esp32_youtube_series repository, licensed under the GNU GPL 2.0. 
 * 
 * Simon Howroyd s.howroyd@livelinkaerospace.com
 * Copyright (C) 2022 Simon Howroyd
 *
 * This file is licensed under the GNU GPL 2.0. See the LICENSE file for more information.
 */
...
public:
	...
	/// @brief Run ESP NVS Flash and open partition
	///
	/// @return 
	/// 	- ESP_OK
    ...
    [[nodiscard]] esp_err_t init(void)
        {
            ...
            ret = _open(partition_name, handle);
            return ret;
        }
    ...
    /// @brief Remove an item in the NVS
	///
	/// @param[in] key   : cstring key of existing item in NVS
	/// @return 
	/// 	- ESP_OK if the item was written and verified
	/// 	- other error codes from underlying NVS API
